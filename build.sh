...
# Repo URL
CLANG_REPO="https://github.com/Busetdah/proton-clang"
ANYKERNEL_REPO="https://github.com/cahya03/AnyKernel3.git"
...
TELEGRAM_TOKEN="1359565160:AAE3Ul1NPcs_cZmuf3Og1eRRdZL45ahSYSU" # Get from botfather
...
END=$(date +"%s")
DIFF=$(( END - START ))
tg_cast "Build for ${DEVICE} with ${COMPILER_STRING} <b>succeed</b> took $((DIFF / 60)) minute(s) and $((DIFF % 60)) second(s)! @cahya03"
